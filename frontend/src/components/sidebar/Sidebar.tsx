        ...
        {isLoading ? (
          ...
          chats.map((chat) => (
            <button
              ...
              className={`w-full text-left px-3 py-2 text-sm rounded-lg transition-all duration-200 hover:translate-x-1 truncate ${
                selectedChatId === chat.id 
                  ? "bg-[#1E293B] text-white font-medium shadow-sm border border-[#1E293B]" 
